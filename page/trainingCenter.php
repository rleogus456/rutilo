	...
	<section class="section03">	
		...
		<article class="intro">
            <div id="floating-panel">
                <div>
                    <select name="sido" id="areaSel" class="input03">
                        <option value="">지역</option>
                    </select>
                    <select name="" id="areaSel2" class="input03">
                        <option value="">시/구/군</option>
                    </select>
                    <input id="address" class="input01" type="textbox" placeholder="센터명" maxlength="10">      
...
function geocodeAddress(geocoder, resultsMap) {
    ...
    var areaSel = document.getElementById('areaSel').value;
    var areaSel2 = document.getElementById('areaSel2').value;
    var addr = document.getElementById('address').value;
    var address = areaSel+areaSel2+addr;
