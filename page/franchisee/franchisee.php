...
<section class="section03">
    <header>
		<h4>가맹문의</h4>
		    <p>루틸로의 차별화된 사업전망에 대해 안내해드립니다.</p>		
	</header> 
	<article id="mall_buy" class="wrap">		
		<div class="width-fixed">
			<form action="<?php echo G5_URL."/page/franchisee/franchiseeUpdate.php"; ?>" method="post" name="cart_list" id="cart_list">
				...
				<div class="price_info" id="cart">				
					...
					<div class="form_list01">
						...
						<ul style="border-top:none">
							<li class="first">
								<div>
									<label for="reg_mb_name">성명</label>
									<div>
										...
										<p id="msg_mb_id" class="inputMsg"><span>* 한글 15자 영문 30자까지 가능합니다.</span></p>									
									</div>								
								</div>								
							</li>
                            <li>
...
<!--									<input type="text" name="mb_email2" value="<?php echo isset($member['mb_email2'])?$member['mb_email2']:''; ?>" id="reg_mb_email2" required class="input03" maxlength="100">-->
                            ...
                            <li>
                                <div>
                                    <label for="reg_location">지역</label>                                
                                    <div>
                                        <input type="text" name="reg_location" id="reg_location" required class="input01" maxlength="20">
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <label for="reg_question">문의하기</label>
                                    <textarea name="reg_question" id="reg_question" cols="30" rows="10" class="fregister_term"></textarea>
                                </div>
                            </li>
                        </ul>
                    </ul>                    
        ...
        <h2 style="margin:40px 0 -45px 0">개인정보취급방침</h2>
        <textarea readonly>전자상거래(인터넷사이버몰) 표준약관

         표준약관 제10023호
        (2015. 6. 26. 개정)
        제1조(목적) 
        이 약관은 루틸로 회사(전자상거래 사업자)가 운영하는 루틸로 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

        ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

        제2조(정의)
        1. “몰”이란 루틸로 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
        ...
        1. “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 00 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
        ...
        <p><input type="checkbox" name="agree" id="agree" class="check01" /><label for="agree" class="check01_label"></label><label for="agree"><a href="<?php echo G5_URL."/page/guide/privacy.php";?>">개인정보취급방침</a>에 동의합니다.</label></p> 
    </section>
	</div>		
				<div class="btn_group01 mt_60">
					<input  type="button" value="문의하기" class="btn grid_30" onclick="return form_check('buy');" />
				</div>
			</form>
		</div>
	</article>
...
<script type="text/javascript">  
	function form_check(act) { 
	    ...
	    if(act == "buy"){
			f.act.value = act;
			$(f).attr("action",g5_url+"/page/franchisee/franchiseeUpdate.php");
			f.submit();
		}
		return true;
	}
