<?php
	...
	if($id){
		$write=sql_fetch("select * from `gsw_banner` where id='".$id."'");
	}
?>
<!-- 본문 start -->
<div id="wrap">
	<section>
		...
		<article id="admin_academy_write">
			<form action="<?php echo G5_URL."/admin/banner_update.php"; ?>" name="branch_form" id="branch_form" method="post" enctype="multipart/form-data">
