	...
	<section>
		...
		<article id="sell">
				...
				<form action="" method="get">
					<div class="grid_100 text-right">
						...
						<select name="code" class="adm-input01" id="code">
							...
							<option value="<?php echo $code_array[$i]['code']; ?>"<?php echo $code_array[$i]['id']==$code?" selected":""; ?>><?php echo $code_array[$i]['code']; ?></option>
							<?php } ?>
						</select>
						<select name="status" class="adm-input01" id="status">
							<option value="">상태선택</option>
							<option value="0"<?php echo $status==-1?" selected":""; ?>>승인대기</option>
							<option value="1"<?php echo $status==-2?" selected":""; ?>>배송대기</option>
							<option value="2"<?php echo $status==-3?" selected":""; ?>>입금대기</option>
							<option value="3"<?php echo $status==-4?" selected":""; ?>>환불완료</option>
						</select>
					</div>
					<div class="grid_100">
				...
				<table>
					<thead>
						<tr>
							...
							<th class="md_none">배송비</th>
							<th class="md_none">가격</th>
							<th>총가격</th>
							<th>상태</th>
							<?php if($is_admin){ ?><th>관리</th><?php } ?>
						</tr>
					</thead>
					<tbody>
					<?php
					...
					?>
						<tr>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'" class="md_none"><?php echo $list[$i]['num']; ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo date("Y-m-d",strtotime($list[$i]['datetime'])); ?><br /><?php echo date("H:m:i",strtotime($list[$i]['datetime'])); ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo $list[$i]['title']; ?><?php if($list[$i]['pcount']>1){ ?> 외 <?php echo $list[$i]['pcount']-1 ?>제품<?php } ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo $list[$i]['mb_name']; ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo $list[$i]['mb_email']; ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo $list[$i]['mb_id']; ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo $list[$i]['re_name']; ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo $list[$i]['mb_addr']; ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'" class="md_none">¥ <?php echo number_format($list[$i]['delivery']); ?></td>
							...
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'">¥ <?php echo number_format($list[$i]['total_price']); ?></td>
							<td onclick="javascript:location.href='<?php echo G5_URL."/admin/sell_view.php?page=".$page."&id=".$list[$i]['id']."&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>'"><?php echo $act; ?></td>
							<?php if($is_admin){ ?>
							<td>
					...
					<?php
						...
						if(count($list)==0){
							echo "<tr><td colspan='14' class='text-center' style='padding:100px 0;'>목록이 없습니다</td></tr>";
						}
					?>
					</tbody>
				</table>
			...
			<div class="text-right mt20">
				<a href="<?php echo G5_URL."/admin/sell_excel.php?page=".$page."&act=0&category=".$category."&code=".$code."&status=".$status."&start=".$start."&end=".$end."&sel=".$sel."&search=".$search; ?>" class="adm-btn01">엑셀로 저장</a>
			</div>
		</article>
	</section>
</div>
